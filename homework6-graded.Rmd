...
**JC Grading -4**
To create a class, first create a function that returns an object of class cohort.  Then develop methods mean.cohort and print.cohort.  Check out Cole's solution on slack.